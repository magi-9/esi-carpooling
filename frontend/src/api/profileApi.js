...
export const updateProfile = (userId, data) =>
    client.put(`/profiles/${userId}`, data);

export const getVehicles = (userId) =>
    client.get(`/profiles/${userId}/vehicles`);

export const addVehicle = (userId, data) =>
    client.post(`/profiles/${userId}/vehicles`, data);

export const getVerifiedVehicles = (userId) =>
    client.get(`/profiles/${userId}/vehicles/verified`);
