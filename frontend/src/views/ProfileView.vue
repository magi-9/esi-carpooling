                ...
                <n-space vertical>
                    ...
                    <n-form v-if="!loading" :model="profileForm" :rules="profileRules">
                        <n-form-item label="First Name" path="firstName">
                            <n-input v-model:value="profileForm.firstName" placeholder="Enter first name"
                                @blur="saveProfileChanges" />
                        </n-form-item>

                        <n-form-item label="Last Name" path="lastName">
                            <n-input v-model:value="profileForm.lastName" placeholder="Enter last name"
                                @blur="saveProfileChanges" />
                        </n-form-item>

                        <n-form-item label="Phone Number" path="phoneNumber">
                            <n-input v-model:value="profileForm.phoneNumber" placeholder="Enter phone number"
                                @blur="saveProfileChanges" />
                        </n-form-item>
                            ...
                            <div v-for="vehicle in vehicles" :key="vehicle.vehicleId" class="vehicle-item">
                                <n-card size="small">
                                    <n-space>
                                        ...
                                        <div>
                                            <n-tag v-if="vehicle.isVerified" type="success">
                                                ✓ Verified
                                            </n-tag>
...
const addNewVehicle = async () => {
    try {
        if (
            ...
            !vehicleForm.value.licensePlate
        ) {
